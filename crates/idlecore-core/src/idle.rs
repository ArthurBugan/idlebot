...
//! Anti-cheat: server validates with server clock; client uses local time.
//! SpacetimeDB server calculates and applies gains every 5 minutes.
...
/// Check if idle time exceeds the minimum threshold (1 minute)
